...
Investment helps raise an economy’s capital stock, which is another way of saying it increases the number of tools we can work with. These new tools and technologies make an impact on our productivity — how much we’re able to get done with the same amount of inputs. As a component of GDP, measuring investment helps us measure an economy’s output. It’s the most volatile component as the animation below shows, it rises and falls by larger amounts based on how optimistic firms are about the future. 
