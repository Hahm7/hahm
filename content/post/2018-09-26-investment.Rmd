...
It therefore makes sense to look at the real ratios of investment to gdp to see if the nominal figure was just capturing falling costs. I use log ratios to avoid misinterpreting chained dollar ratios as this article <a href="http://econbrowser.com/archives/2018/03/assessing-trends-in-real-shares" target="_blank">explains</a>. I then use the log ratio and express it relative to a base year value (1967 in my case) as explained <a href="http://econbrowser.com/archives/2015/08/to-log-or-not-to-log-part-iii" target="_blank">here</a>, to get the cumulative percentage changes. A percentage shows a part of the whole and cumulative percentages adds a percentage from one period to the percentages of another so we could if this part of the whole has become more important over the years. If the log ratio falls below zero, then the real investment growth has cumulatively fallen short of cumulative GDP growth.
We can see that Real gross investment has cumulatively grown since 1967. While Real net investment has cumulatively risen since 1967, there is a growing gap between net and gross since net investment reached its peak level in the 90s. 
