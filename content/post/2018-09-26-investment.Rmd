...
mytheme <- theme(plot.caption=element_text(hjust=0,size=9),
                 ...
                 axis.title.x = element_text(margin = margin(10,15,0,0), size = 15, face = "bold"),
                 axis.title.y = element_text(margin = margin(15,15,0,0), size = 15, face = "bold"),
                 axis.text.x = element_text(size=10),
                 axis.text.y = element_text(size=10)) 
  
  
plot <- ggplot(df, aes(x =date, y = gfcf_gdp)) +
  geom_line(size = 1.1) +
  scale_color_manual(values=c("#0072B2")) +
  labs(y = "Percent of GDP", x = "Date", caption = "Source: Integrated Macroeconomic Accounts Of the United States") +
  ylim(0, 15) +
  scale_x_continuous(breaks=seq(1960, 2017, 5))+
  ggtitle("Gross Nonfinancial Fixed Capital Formation") +
  mytheme
