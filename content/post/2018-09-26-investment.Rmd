...
fixed <- fixed %>% 
  select(date, logratio_net, logratio_pfni)

colnames(fixed)[2]<-"Log ratio Net Investment"
colnames(fixed)[3]<-"Log ratio Gross Ivestment"
