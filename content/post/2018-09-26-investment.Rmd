...
Investment is a component of GDP — a measure of an economy’s output. It’s the most volatile component as the animation below shows as it quickly rises and falls based on how optimistic firms are about the future. 
...
mydir <- "C:/Users/Hamdi/Desktop/Website/Hahm"
...
volatile_gif <- save_gif({for (i in seq(1,M)){  
  g<- volatile.plot(i)
  print(g)
