...
capt = "Log ratio of real gross and net investment to real GDP (Chained $2012), normalized to 1967=0. Gross investment is private nonresidential fixed investment. Net is gross minus depreciation. Source: BEA and author's calculations"
...
capt = "Log ratio of net investment to real GDP (Chained $2012), normalized to 2000=0. Gross investment is private nonresidential fixed investment. Net is gross minus depreciation. Source: BEA and author's calculations"
...
capt2 = "Log ratio of real net investment to real gross investment (Chained $2012). Gross investment is private nonresidential fixed investment. Net is gross minus depreciation. Source: BEA and author's calculations"
...
net_log_ratio <- ggplot(fixed2.df, aes(x =date, y = percent, color = indicator, label = indicator)) +
  scale_color_manual(values=c("#D55E00")) +
  geom_line(size = 1) +
  labs(x = "Date", y = "Net Log Ratio", caption = capt2) +
  ylim(-3, -1) +
  scale_x_continuous(breaks=seq(1967, 2017, 5))+
...
This suggests a greater amount of investment is being devoted to replacing older capital stock instead of adding to stock. So, what could explain this?
...
So, not only is investment in the new economy resource-intensive, investment in general has a bad record in terms of returns. In realising this, maybe businesses may have wised up and would prefer to wait it out before deploying funds towards making investments.
