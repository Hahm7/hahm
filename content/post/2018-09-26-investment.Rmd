...
Grey and Vogel then turned to a paper by <a href="http://theinvestmentcapm.com/HouXueZhang2015RFS.pdf" target="_blank">Kewei Hou, Chen Xue, and Lu Zhang</a> examining the investment factor directly which came to the same conclusion. So, not only is investment in the new economy more expensive to produce, investment in general has a bad record in terms of returns. So after all this, businesses may think why they should spend all that money and effort if the ideas or tech they produce will be replaced by better ones in the future. They may be playing a game where it pays to be a second mover.
