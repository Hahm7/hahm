...
<a href="https://www.federalreserve.gov/econres/notes/ifdp-notes/corporate-buybacks-and-capital-investment-an-international-perspective-20170411.htm</a>

I use investment defined as gross fixed capital formation undertaken by the non-financial corporate sector. Gross <a href="https://en.wikipedia.org/wiki/Fixed_capital" target="_blank">fixed capital</a> formation measures the net increase in fixed capital investment which is a component of the <a href="http://www.econport.org/content/handbook/NatIncAccount/CalculatingGDP/Expenditures.html" target="_blank">expenditure method in calculating</a>. Both data sets are from the <a href="https://www.federalreserve.gov/econres/notes/ifdp-notes/corporate-buybacks-and-capital-investment-an-international-perspective-20170411.htm</a>.

### **Are buybacks holding back investment?**

The point made by those that say yes is that corporate executives are incentivised to buyback shares above all else as it is an easy method to drive up the share price. This is because buybacks reduce the number of shares in the market and that should increase the price of the remaining shares. There is evidence of [buybacks]( https://papers.ssrn.com/sol3/papers.cfm?abstract_id=250049) [raising]( https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2664098) share prices. But this evidence has less to do with buybacks cutting the number of shares available and instead supports this [explanation](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3082460) by Clifford Asness et al:
...
If buybacks don’t deter investment through the lure of higher share prices, then they may do so through the lure of higher earnings per [share](http://uk.businessinsider.com/contribution-buybacks-eps-growth-2015-11):
