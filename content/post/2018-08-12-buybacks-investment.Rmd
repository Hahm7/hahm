...
The point made by those that say yes is that corporate executives are incentivised to buyback shares above all else as it is an easy method to drive up the share price. This is because share buybacks reduce the number of shares in the market and that should increase the price of the remaining shares. There is evidence that share [buybacks]( https://papers.ssrn.com/sol3/papers.cfm?abstract_id=250049) do [raise]( https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2664098) share prices. But this evidence has less to do with buybacks cutting the number of shares available and instead supports this [explanation](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3082460) by Clifford Asness et al:
...
There doesn’t seem to be strong evidence that shows higher share prices and EPS are the sole drivers of buyback decisions. If anything, the long term correlation between net_buybacks and investment is positive and the correlation in the last 15 years has also been positive. At worst, companies could be giving back money to shareholders because of a lack of profitable projects to [invest in](https://johnhcochrane.blogspot.com/2017/12/the-buyback-fallacy.html). This may be bad for individual companies and shareholders but this may not be a bad thing for the economy as a whole as  John Cochrane [explains]](https://johnhcochrane.blogspot.com/2017/12/the-buyback-fallacy.html):
...
Whilst these two things may compete with investment decisions in the short term, a good counterfactual to all of this would be to look at whether investment decisions would go ahead if buybacks were not possible. I explore this further in my next post.
