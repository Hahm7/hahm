...
The longer the time period, the riskier the venture becomes because it is harder to predict out into the distant future and investment which looked profitable at the time may turn out to be a loss maker. So, buybacks can be strategically undertaken in order to artificially raise EPS in the short term and corporate executives whose compensation is based on stock options will have an incentive to do this as Clifford Asness et al recognize:
...
Indeed, there's evidence that suggests incentives could be skewed towards the short term [happening](https://hbr.org/2014/09/profits-without-prosperity):
...
There doesn’t seem to be strong evidence that shows higher share prices and EPS are the sole drivers of buyback decisions. Whilst these two things may compete with investment decisions in the short term, a good counterfactual to all of this would be to look at whether investment decisions would go ahead if buybacks were not possible. I look at this in my next post.


### **TLDR**

All of this shows that the negative effect of buybacks on investment is weak at best. So, if rising buybacks aren't behind sluggish investment, what could be? I explore them in my next post. Thank you for reading.
