...
In [theory](https://corporatefinanceinstitute.com/resources/knowledge/finance/hurdle-rate-definition/) an investment should be made if its return exceeds its hurdle rate and less cash being available through share repurchases shouldn't stop the investment going ahead since cash is not the only source of [funds](https://www.oecd-ilibrary.org/economics/understanding-financial-accounts/the-financing-of-non-financial-corporations_9789264281288-8-en). What could discourage corporate executives from undertaking investment is that the benefits of investment are accrued in the long run and the Mckinsey report shows that share repurchases are more lucrative than investment in the short run. 
...
The longer the time period, the riskier the venture becomes because it is harder to predict out into the distant future and an investment which looked profitable at the time may turn out to be a loss maker. So, buybacks can be strategically undertaken in order to artificially raise EPS in the short term and corporate executives whose compensation is based on stock options will have an incentive to do this as Clifford Asness et al recognize:
...
Indeed, there’s evidence that suggests incentives could be skewed in S&P500 [companies](https://hbr.org/2014/09/profits-without-prosperity):
