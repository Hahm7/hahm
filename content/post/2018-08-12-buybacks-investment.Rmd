...
In [theory](https://corporatefinanceinstitute.com/resources/knowledge/finance/hurdle-rate-definition/) an investment should be made if it's retrn exceeds it's hurdle rate and less cash being available through share repurchases shouldn't stop the company from doing this since it is not the only source of [funds](https://www.oecd-ilibrary.org/economics/understanding-financial-accounts/the-financing-of-non-financial-corporations_9789264281288-8-en). Even if share repurchases lead to a higher EPS, it should not be competing with a profitable investment project. What could discourage corporate executives from undertaking investment is that benefits of investment are accrued in the long run and the Mckinsey report shows share repurchases are more lucrative than investment in the short run. 
...
The longer the time period, the riskier the enveour becomes because it is harder to predict out into the distant future and investment which looked profitable at the time may turn out to be a loss maker. So, buybacks can be strategially undertaken in order to artificially raise EPS in the short term and corporate executives whose compensiation is based on stock options will have an incentive to do this as Clifford Asness et al recognize:
...
Indeed, there's evidence that suggests incentives could be sweked towards the short term [happening](https://hbr.org/2014/09/profits-without-prosperity):
...
There doens't seem to be strong evidence that shows higher share prices and EPS are the sole drivers of buyback decisions. Whilst these two things may compete with investment decisions in the short term, a good counter factual to all of this would be to look at whether investment decisions would go ahead if buybacks were not possible. I look at this in my next post.


### **TLDR**

All of this shows that the negative effect of buybacks on investment is weak at best. So, if rising buybacks aren't behind sluggish investment, what could be? I expore them in my next post. Thank you for reading.
