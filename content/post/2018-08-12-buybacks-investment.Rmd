...
mytheme <- theme(axis.line.y = element_line(colour = "black", size = 0.1),
                 ...
                 axis.title.x = element_text(size = 15, margin = margin(-5,0,40,0)),
                 axis.title.y = element_text(size = 15, margin = margin(10,6,0,0)),
...
d <- ggplot(f, aes(observation_date, frame = frame)) +
  ...
  annotate("text", label = "Tax Cut Approved", x = plot$observation_date[17], y = 0, color = "black", size = 4.7) +
