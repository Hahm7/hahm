...
```{r}
# Average visibility per product

avg_item_visib <- joined %>% 
                    group_by(Item_Identifier) %>% 
                    summarise(avg_visib = mean(Item_Visibility, na.rm = TRUE))

# Create indicator variable showing which have missing values
...
joined %>% 
  summarise(mean = mean(Item_Visib_Mean_Ratio, na.rm = TRUE),
